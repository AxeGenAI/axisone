...
const Profile: React.FC = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    website: 'https://profiles.stanford.edu/richardson',
    bio: 'Leading researcher in molecular biology and protein structure analysis with over 15 years of experience. Passionate about advancing scientific discovery through collaborative research and innovative methodologies.',
    expertise: ['Molecular Biology', 'Protein Analysis', 'Bioinformatics', 'Research Management'],
  ...
  const stats = [
    { label: 'Projects', value: '24', icon: Briefcase, color: 'text-blue-600' },
    { label: 'Collaborations', value: '127', icon: Users, color: 'text-green-600' },
    { label: 'Publications', value: '89', icon: Award, color: 'text-purple-600' },
    { label: 'Citations', value: '2.4K', icon: Star, color: 'text-yellow-600' }
  ];
  ...
  const recentActivity = [
    {
      id: '1',
      type: 'project',
      description: 'Created new research project: Neural Network Analysis',
    ...
    },
    {
      id: '2',
      type: 'collaboration',
      description: 'Invited Dr. Sarah Chen to Microbiome Research project',
      timestamp: '1 day ago',
    ...
    },
    {
      id: '3',
      type: 'publication',
      description: 'Published research paper on protein structure prediction',
    ...
    },
    {
      id: '4',
      type: 'award',
      description: 'Received Excellence in Research Award',
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case 'publication': return <Award className="w-4 h-4 text-purple-600" />;
      case 'award': return <Star className="w-4 h-4 text-yellow-600" />;
  ...
  const renderActivity = () => (
    <Section>
      <SectionHeader title="Recent Activity" subtitle="Your latest research activities and achievements" />
      <div className="space-y-4">
